...
const Header = () => {
  return (
    <div className='text-[12px] flex items-center justify-center w-full h-[50px]'>
      ...
      <button className='px-1 ml-2 border-2 border-black rounded-lg hover:text-red-600 hover:border-red-600 py-1/2'>
        <p>iOS</p>
      </button>
      <button className='px-1 ml-2 border-2 border-black border-black rounded-lg py-1/2'>
        <p>Android</p>
      </button>
      <div className='ml-2'>
        <p>
      ...
      <div>
        <input className='border-2 border-black rounded-md' placeholder='Nhập số điện thoại...'/>
      </div>
      <div>
        <button className='ml-2 border-2 border-black rounded-md'>Gửi link</button>
      </div>
